...
python -m PyInstaller --noconfirm --clean --onefile --noconsole --add-binary ".build-tools\geckodriver\geckodriver.exe;." --add-data "$GeoFile;data" --name brainbox-engine desktop_backend.py
