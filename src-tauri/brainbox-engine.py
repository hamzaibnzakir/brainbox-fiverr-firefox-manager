...
class Engine:
    ...
    def _launch_process(self, pid: str, p: dict[str, Any]) -> None:
        ...
        args = [binary, "--no-remote", "--profile", str(path), p.get("targetWebsite") or self.config.get("website", "https://www.fiverr.com/users/manage_gigs")]
        ...
        self._log("browser-open", "Firefox profile launched", p.get("name"))
