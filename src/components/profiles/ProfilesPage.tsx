...
export function ProfilesPage() {
  const { profiles, discoveredFirefoxProfiles, launchProfile, stopProfile, refreshProfile, duplicateProfile, deleteProfile, updateProfile, createProfile, testProxy } = useAppData();
  const [query,setQuery]=useState(""); const [selectedId,setSelectedId]=useState<string|null>(null); const [editingId,setEditingId]=useState<string|null>(null); const [addOpen,setAddOpen]=useState(false);
